      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="py-24 md:py-24 lg:py-0">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-black">
            Le Premier Calculateur<br />
            <span className="bg-gradient-to-r from-black to-gray-600 bg-clip-text text-transparent">
              Carbon Tunisien
            </span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-700 max-w-3xl mx-auto">
            Solution complète de calcul et gestion d'empreinte carbone pour les entreprises tunisiennes. Vos données restent en Tunisie, votre croissance aussi.
          </p>
